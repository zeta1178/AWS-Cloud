...
After presenting the Lambda function's building blocks, open the `lambda_function.py` script on VSCode, delete the sample code, and copy and paste the code from VSCode to the code editor on the AWS Lambda console. Click the "Deploy" button to continue.
